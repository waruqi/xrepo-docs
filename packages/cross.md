...
```console
xrepo install -p cross [--sdk=/xxx] alpaka
```
...
```console
xrepo install -p cross [--sdk=/xxx] approval-tests-cpp
```
...
```console
xrepo install -p cross [--sdk=/xxx] aubio
```
...
```console
xrepo install -p cross [--sdk=/xxx] aui-toolbox
```
...
```console
xrepo install -p cross [--sdk=/xxx] base64-zhicheng
```
...
| License | zlib |
| Versions | 1.5.2 |
| Architectures | arm64, loong64, mips64, mips64el, ppc64, ppc64el, riscv64, sparc64, x86_64 |
| Definition | [bc_crunch/xmake.lua](https://github.com/xmake-io/xmake-repo/blob/master/packages/b/bc_crunch/xmake.lua) |

##### Install command

```console
xrepo install -p cross [--sdk=/xxx] bc_crunch
```
...
```console
xrepo install -p cross [--sdk=/xxx] beaengine
```
...
```console
xrepo install -p cross [--sdk=/xxx] boost_config
```
...
```console
xrepo install -p cross [--sdk=/xxx] boost_math
```
...
```console
xrepo install -p cross [--sdk=/xxx] box3d
```
...
```console
xrepo install -p cross [--sdk=/xxx] cjson
```
...
```console
xrepo install -p cross [--sdk=/xxx] clay
```
...
```console
xrepo install -p cross [--sdk=/xxx] cli11
```
...
```console
xrepo install -p cross [--sdk=/xxx] clove-unit
```
...
```console
xrepo install -p cross [--sdk=/xxx] cmark
```
...
```console
xrepo install -p cross [--sdk=/xxx] cmdparser
```
...
```console
xrepo install -p cross [--sdk=/xxx] cnats
```
...
```console
xrepo install -p cross [--sdk=/xxx] coin-or-coinutils
```
...
```console
xrepo install -p cross [--sdk=/xxx] coin-or-osi
```
...
```console
xrepo install -p cross [--sdk=/xxx] console-bridge
```
...
```console
xrepo install -p cross [--sdk=/xxx] cpp-channel
```
...
```console
xrepo install -p cross [--sdk=/xxx] cpp-ipc
```
...
```console
xrepo install -p cross [--sdk=/xxx] cpp-jwt
```
...
```console
xrepo install -p cross [--sdk=/xxx] cpp-rotor
```
...
```console
xrepo install -p cross [--sdk=/xxx] cpp-semver
```
...
```console
xrepo install -p cross [--sdk=/xxx] cpp-sort
```
...
```console
xrepo install -p cross [--sdk=/xxx] cpp20-http-client
```
...
```console
xrepo install -p cross [--sdk=/xxx] cppad
```
...
```console
xrepo install -p cross [--sdk=/xxx] cppcodec
```
...
```console
xrepo install -p cross [--sdk=/xxx] cppitertools
```
...
```console
xrepo install -p cross [--sdk=/xxx] cppli
```
...
```console
xrepo install -p cross [--sdk=/xxx] cpptrace
```
...
```console
xrepo install -p cross [--sdk=/xxx] cppunit
```
...
```console
xrepo install -p cross [--sdk=/xxx] cppzmq
```
...
```console
xrepo install -p cross [--sdk=/xxx] cpr
```
...
```console
xrepo install -p cross [--sdk=/xxx] cpu-features
```
...
```console
xrepo install -p cross [--sdk=/xxx] cr
```
...
```console
xrepo install -p cross [--sdk=/xxx] crashcatch
```
...
```console
xrepo install -p cross [--sdk=/xxx] criterion
```
...
```console
xrepo install -p cross [--sdk=/xxx] croaring
```
...
```console
xrepo install -p cross [--sdk=/xxx] croncpp
```
...
```console
xrepo install -p cross [--sdk=/xxx] crow
```
...
```console
xrepo install -p cross [--sdk=/xxx] crstl
```
...
```console
xrepo install -p cross [--sdk=/xxx] cryptopp
```
...
```console
xrepo install -p cross [--sdk=/xxx] ctpg
```
...
```console
xrepo install -p cross [--sdk=/xxx] cunit
```
...
```console
xrepo install -p cross [--sdk=/xxx] curl
```
...
```console
xrepo install -p cross [--sdk=/xxx] curlcpp
```
...
```console
xrepo install -p cross [--sdk=/xxx] cwt-cucumber
```
...
```console
xrepo install -p cross [--sdk=/xxx] cxxgraph
```
...
```console
xrepo install -p cross [--sdk=/xxx] darts
```
...
```console
xrepo install -p cross [--sdk=/xxx] dascript
```
...
```console
xrepo install -p cross [--sdk=/xxx] datatype99
```
...
```console
xrepo install -p cross [--sdk=/xxx] dav1d
```
...
```console
xrepo install -p cross [--sdk=/xxx] daw_header_libraries
```
...
```console
xrepo install -p cross [--sdk=/xxx] daw_json_link
```
...
```console
xrepo install -p cross [--sdk=/xxx] dfdutils
```
...
```console
xrepo install -p cross [--sdk=/xxx] dipp
```
...
```console
xrepo install -p cross [--sdk=/xxx] dispenso
```
...
```console
xrepo install -p cross [--sdk=/xxx] dlib
```
...
```console
xrepo install -p cross [--sdk=/xxx] dlpack
```
...
```console
xrepo install -p cross [--sdk=/xxx] double-conversion
```
...
```console
xrepo install -p cross [--sdk=/xxx] dragonbox
```
...
```console
xrepo install -p cross [--sdk=/xxx] drogon
```
...
```console
xrepo install -p cross [--sdk=/xxx] duktape
```
...
```console
xrepo install -p cross [--sdk=/xxx] dylib
```
...
```console
xrepo install -p cross [--sdk=/xxx] dyncall
```
...
```console
xrepo install -p cross [--sdk=/xxx] eabase
```
...
```console
xrepo install -p cross [--sdk=/xxx] easy_profiler
```
...
```console
xrepo install -p cross [--sdk=/xxx] easywsclient
```
...
```console
xrepo install -p cross [--sdk=/xxx] embedded-xoodyak
```
...
```console
xrepo install -p cross [--sdk=/xxx] emhash
```
...
```console
xrepo install -p cross [--sdk=/xxx] emio
```
...
```console
xrepo install -p cross [--sdk=/xxx] emock
```
...
```console
xrepo install -p cross [--sdk=/xxx] esp32-arduino-libs
```
...
```console
xrepo install -p cross [--sdk=/xxx] esp32-devel
```
...
```console
xrepo install -p cross [--sdk=/xxx] esptool
```
...
```console
xrepo install -p cross [--sdk=/xxx] etl
```
...
```console
xrepo install -p cross [--sdk=/xxx] eudev
```
...
```console
xrepo install -p cross [--sdk=/xxx] eventpp
```
...
```console
xrepo install -p cross [--sdk=/xxx] exosip
```
...
```console
xrepo install -p cross [--sdk=/xxx] expresscpp
```
...
```console
xrepo install -p cross [--sdk=/xxx] extra-cmake-modules
```
...
```console
xrepo install -p cross [--sdk=/xxx] fadec
```
...
```console
xrepo install -p cross [--sdk=/xxx] fakeit
```
...
```console
xrepo install -p cross [--sdk=/xxx] faker-cxx
```
...
```console
xrepo install -p cross [--sdk=/xxx] fann
```
...
```console
xrepo install -p cross [--sdk=/xxx] fast-cdr
```
...
```console
xrepo install -p cross [--sdk=/xxx] fast-lzma2
```
...
```console
xrepo install -p cross [--sdk=/xxx] fast_obj
```
...
```console
xrepo install -p cross [--sdk=/xxx] fastmod
```
...
```console
xrepo install -p cross [--sdk=/xxx] fatal
```
...
```console
xrepo install -p cross [--sdk=/xxx] fcgi
```
...
```console
xrepo install -p cross [--sdk=/xxx] fcl
```
...
```console
xrepo install -p cross [--sdk=/xxx] fcpw
```
...
```console
xrepo install -p cross [--sdk=/xxx] fdk-aac
```
...
```console
xrepo install -p cross [--sdk=/xxx] fftw
```
...
```console
xrepo install -p cross [--sdk=/xxx] fgt
```
...
```console
xrepo install -p cross [--sdk=/xxx] filc
```
...
```console
xrepo install -p cross [--sdk=/xxx] fixed-containers
```
...
```console
xrepo install -p cross [--sdk=/xxx] flann
```
...
```console
xrepo install -p cross [--sdk=/xxx] flatcc
```
...
```console
xrepo install -p cross [--sdk=/xxx] flecs
```
...
```console
xrepo install -p cross [--sdk=/xxx] fontconfig
```
...
```console
xrepo install -p cross [--sdk=/xxx] freerdp
```
...
```console
xrepo install -p cross [--sdk=/xxx] freexl
```
...
```console
xrepo install -p cross [--sdk=/xxx] function2
```
...
```console
xrepo install -p cross [--sdk=/xxx] gcem
```
...
```console
xrepo install -p cross [--sdk=/xxx] gelldur-eventbus
```
...
```console
xrepo install -p cross [--sdk=/xxx] geode-sdk-result
```
...
```console
xrepo install -p cross [--sdk=/xxx] gfx-timsort
```
...
```console
xrepo install -p cross [--sdk=/xxx] gklib
```
...
```console
xrepo install -p cross [--sdk=/xxx] glaze
```
...
```console
xrepo install -p cross [--sdk=/xxx] glfw
```
...
```console
xrepo install -p cross [--sdk=/xxx] glibmm
```
...
```console
xrepo install -p cross [--sdk=/xxx] gloo
```
...
```console
xrepo install -p cross [--sdk=/xxx] glpk
```
...
```console
xrepo install -p cross [--sdk=/xxx] gmp
```
...
```console
xrepo install -p cross [--sdk=/xxx] gmssl
```
...
```console
xrepo install -p cross [--sdk=/xxx] google-cloud-cpp
```
...
```console
xrepo install -p cross [--sdk=/xxx] graaf
```
...
```console
xrepo install -p cross [--sdk=/xxx] graphene
```
...
```console
xrepo install -p cross [--sdk=/xxx] grpc
```
...
```console
xrepo install -p cross [--sdk=/xxx] gsl-lite
```
...
```console
xrepo install -p cross [--sdk=/xxx] gstreamer
```
...
```console
xrepo install -p cross [--sdk=/xxx] gtl
```
...
```console
xrepo install -p cross [--sdk=/xxx] gz-cmake
```
...
```console
xrepo install -p cross [--sdk=/xxx] gz-math
```
...
```console
xrepo install -p cross [--sdk=/xxx] gz-utils
```
...
```console
xrepo install -p cross [--sdk=/xxx] gzip-hpp
```
...
```console
xrepo install -p cross [--sdk=/xxx] h3
```
...
```console
xrepo install -p cross [--sdk=/xxx] hexl
```
...
```console
xrepo install -p cross [--sdk=/xxx] highs
```
...
```console
xrepo install -p cross [--sdk=/xxx] highway
```
...
```console
xrepo install -p cross [--sdk=/xxx] hiredis-vip
```
...
```console
xrepo install -p cross [--sdk=/xxx] hyperscan
```
...
```console
xrepo install -p cross [--sdk=/xxx] hyprwayland-scanner
```
...
```console
xrepo install -p cross [--sdk=/xxx] icu4c
```
...
```console
xrepo install -p cross [--sdk=/xxx] idna
```
...
```console
xrepo install -p cross [--sdk=/xxx] imath
```
...
```console
xrepo install -p cross [--sdk=/xxx] imgui
```
...
```console
xrepo install -p cross [--sdk=/xxx] imgui-file-dialog
```
...
```console
xrepo install -p cross [--sdk=/xxx] implot
```
...
```console
xrepo install -p cross [--sdk=/xxx] implot3d
```
...
```console
xrepo install -p cross [--sdk=/xxx] incbin
```
...
```console
xrepo install -p cross [--sdk=/xxx] inifile-cpp
```
...
```console
xrepo install -p cross [--sdk=/xxx] interface99
```
...
```console
xrepo install -p cross [--sdk=/xxx] intx
```
...
```console
xrepo install -p cross [--sdk=/xxx] isocline
```
...
```console
xrepo install -p cross [--sdk=/xxx] itlib
```
...
```console
xrepo install -p cross [--sdk=/xxx] ittapi
```
...
```console
xrepo install -p cross [--sdk=/xxx] jack2
```
...
```console
xrepo install -p cross [--sdk=/xxx] jansson
```
...
```console
xrepo install -p cross [--sdk=/xxx] jerryscript
```
...
```console
xrepo install -p cross [--sdk=/xxx] jpcre2
```
...
```console
xrepo install -p cross [--sdk=/xxx] jrtplib
```
...
```console
xrepo install -p cross [--sdk=/xxx] json-c
```
...
```console
xrepo install -p cross [--sdk=/xxx] jthread
```
...
```console
xrepo install -p cross [--sdk=/xxx] jwasm
```
...
```console
xrepo install -p cross [--sdk=/xxx] kangaru
```
...
```console
xrepo install -p cross [--sdk=/xxx] kenlm
```
...
```console
xrepo install -p cross [--sdk=/xxx] khaledhosny-ots
```
...
```console
xrepo install -p cross [--sdk=/xxx] klib
```
...
```console
xrepo install -p cross [--sdk=/xxx] lcms
```
...
```console
xrepo install -p cross [--sdk=/xxx] leancrypto
```
...
```console
xrepo install -p cross [--sdk=/xxx] lerc
```
...
```console
xrepo install -p cross [--sdk=/xxx] leveldb
```
...
```console
xrepo install -p cross [--sdk=/xxx] liba52
```
...
```console
xrepo install -p cross [--sdk=/xxx] libatomic_ops
```
...
```console
xrepo install -p cross [--sdk=/xxx] libbcrypt
```
...
```console
xrepo install -p cross [--sdk=/xxx] libbsd
```
...
```console
xrepo install -p cross [--sdk=/xxx] libcbor
```
...
```console
xrepo install -p cross [--sdk=/xxx] libcoro
```
...
```console
xrepo install -p cross [--sdk=/xxx] libcron
```
...
```console
xrepo install -p cross [--sdk=/xxx] libdatachannel
```
...
```console
xrepo install -p cross [--sdk=/xxx] libde265
```
...
```console
xrepo install -p cross [--sdk=/xxx] libdeflate
```
...
```console
xrepo install -p cross [--sdk=/xxx] libdicom
```
...
```console
xrepo install -p cross [--sdk=/xxx] libdisasm
```
...
```console
xrepo install -p cross [--sdk=/xxx] libdispatch
```
...
```console
xrepo install -p cross [--sdk=/xxx] libdwarf
```
...
```console
xrepo install -p cross [--sdk=/xxx] libebur128
```
...
```console
xrepo install -p cross [--sdk=/xxx] libeconf
```
...
```console
xrepo install -p cross [--sdk=/xxx] libelfin
```
...
```console
xrepo install -p cross [--sdk=/xxx] libenvpp
```
...
```console
xrepo install -p cross [--sdk=/xxx] libevent
```
...
```console
xrepo install -p cross [--sdk=/xxx] libflac
```
...
```console
xrepo install -p cross [--sdk=/xxx] libfork
```
...
```console
xrepo install -p cross [--sdk=/xxx] libgit2
```
...
```console
xrepo install -p cross [--sdk=/xxx] libgit2cpp
```
...
```console
xrepo install -p cross [--sdk=/xxx] libhat
```
...
```console
xrepo install -p cross [--sdk=/xxx] libid3tag
```
...
```console
xrepo install -p cross [--sdk=/xxx] libinterpolate
```
...
```console
xrepo install -p cross [--sdk=/xxx] libjq
```
...
```console
xrepo install -p cross [--sdk=/xxx] libkdtree
```
...
```console
xrepo install -p cross [--sdk=/xxx] libkeyfinder
```
...
```console
xrepo install -p cross [--sdk=/xxx] libllvm
```
...
```console
xrepo install -p cross [--sdk=/xxx] liblo
```
...
```console
xrepo install -p cross [--sdk=/xxx] libmaxminddb
```
...
```console
xrepo install -p cross [--sdk=/xxx] libmd
```
...
```console
xrepo install -p cross [--sdk=/xxx] libmetalink
```
...
```console
xrepo install -p cross [--sdk=/xxx] libmobi
```
...
```console
xrepo install -p cross [--sdk=/xxx] libmspack
```
...
```console
xrepo install -p cross [--sdk=/xxx] libmysofa
```
...
```console
xrepo install -p cross [--sdk=/xxx] libnpy-matajoh
```
...
```console
xrepo install -p cross [--sdk=/xxx] libopenmpt
```
...
```console
xrepo install -p cross [--sdk=/xxx] libopus
```
...
```console
xrepo install -p cross [--sdk=/xxx] libp11
```
...
```console
xrepo install -p cross [--sdk=/xxx] libpcap
```
...
```console
xrepo install -p cross [--sdk=/xxx] libpopcnt
```
...
```console
xrepo install -p cross [--sdk=/xxx] libpthread-stubs
```
...
```console
xrepo install -p cross [--sdk=/xxx] libqrencode
```
...
```console
xrepo install -p cross [--sdk=/xxx] librats
```
...
```console
xrepo install -p cross [--sdk=/xxx] libraw
```
...
```console
xrepo install -p cross [--sdk=/xxx] librealsense
```
...
```console
xrepo install -p cross [--sdk=/xxx] librime
```
...
```console
xrepo install -p cross [--sdk=/xxx] librttopo
```
...
```console
xrepo install -p cross [--sdk=/xxx] libsdl2
```
...
```console
xrepo install -p cross [--sdk=/xxx] libsdl2_image
```
...
```console
xrepo install -p cross [--sdk=/xxx] libsdl2_mixer
```
...
```console
xrepo install -p cross [--sdk=/xxx] libsdl2_mixer_x
```
...
```console
xrepo install -p cross [--sdk=/xxx] libsdl2_net
```
...
```console
xrepo install -p cross [--sdk=/xxx] libsdl2_ttf
```
...
```console
xrepo install -p cross [--sdk=/xxx] libsdl3
```
...
```console
xrepo install -p cross [--sdk=/xxx] libsdl3_image
```
...
```console
xrepo install -p cross [--sdk=/xxx] libsdl3_mixer
```
...
```console
xrepo install -p cross [--sdk=/xxx] libsdl3_ttf
```
...
```console
xrepo install -p cross [--sdk=/xxx] libsigcplusplus
```
...
```console
xrepo install -p cross [--sdk=/xxx] libsmb2
```
...
```console
xrepo install -p cross [--sdk=/xxx] libsodium
```
...
```console
xrepo install -p cross [--sdk=/xxx] libsolv
```
...
```console
xrepo install -p cross [--sdk=/xxx] libsquish
```
...
```console
xrepo install -p cross [--sdk=/xxx] libssh
```
...
```console
xrepo install -p cross [--sdk=/xxx] libtasn1
```
...
```console
xrepo install -p cross [--sdk=/xxx] libtcod
```
...
```console
xrepo install -p cross [--sdk=/xxx] libtommath
```
...
```console
xrepo install -p cross [--sdk=/xxx] libusb
```
...
```console
xrepo install -p cross [--sdk=/xxx] libvips
```
...
```console
xrepo install -p cross [--sdk=/xxx] libvorbis
```
...
```console
xrepo install -p cross [--sdk=/xxx] libwebm
```
...
```console
xrepo install -p cross [--sdk=/xxx] libwebsockets
```
...
```console
xrepo install -p cross [--sdk=/xxx] libx11
```
...
```console
xrepo install -p cross [--sdk=/xxx] libxau
```
...
```console
xrepo install -p cross [--sdk=/xxx] libxcb
```
...
```console
xrepo install -p cross [--sdk=/xxx] libxdmcp
```
...
```console
xrepo install -p cross [--sdk=/xxx] libxext
```
...
```console
xrepo install -p cross [--sdk=/xxx] libxml2
```
...
```console
xrepo install -p cross [--sdk=/xxx] libxslt
```
...
```console
xrepo install -p cross [--sdk=/xxx] libzchunk
```
...
```console
xrepo install -p cross [--sdk=/xxx] libzen
```
...
```console
xrepo install -p cross [--sdk=/xxx] libzip
```
...
```console
xrepo install -p cross [--sdk=/xxx] lief
```
...
```console
xrepo install -p cross [--sdk=/xxx] lightmapper
```
...
```console
xrepo install -p cross [--sdk=/xxx] liquid-dsp
```
...
```console
xrepo install -p cross [--sdk=/xxx] llama.cpp
```
...
```console
xrepo install -p cross [--sdk=/xxx] llvm-arm
```
...
```console
xrepo install -p cross [--sdk=/xxx] lmdb
```
...
```console
xrepo install -p cross [--sdk=/xxx] lockfree
```
...
```console
xrepo install -p cross [--sdk=/xxx] ls-hpack
```
...
```console
xrepo install -p cross [--sdk=/xxx] ls-qpack
```
...
```console
xrepo install -p cross [--sdk=/xxx] lsquic
```
...
```console
xrepo install -p cross [--sdk=/xxx] luabridge3
```
...
```console
xrepo install -p cross [--sdk=/xxx] luau
```
...
```console
xrepo install -p cross [--sdk=/xxx] lunzip
```
...
```console
xrepo install -p cross [--sdk=/xxx] lwlog
```
...
```console
xrepo install -p cross [--sdk=/xxx] lzav
```
...
```console
xrepo install -p cross [--sdk=/xxx] lzham_codec
```
...
```console
xrepo install -p cross [--sdk=/xxx] lzma
```
...
```console
xrepo install -p cross [--sdk=/xxx] maddy
```
...
```console
xrepo install -p cross [--sdk=/xxx] mallocvis
```
...
```console
xrepo install -p cross [--sdk=/xxx] manif
```
...
```console
xrepo install -p cross [--sdk=/xxx] manifold
```
...
```console
xrepo install -p cross [--sdk=/xxx] mapbox_polylabel
```
...
```console
xrepo install -p cross [--sdk=/xxx] marchingcubecpp
```
...
```console
xrepo install -p cross [--sdk=/xxx] marisa
```
...
```console
xrepo install -p cross [--sdk=/xxx] marl
```
...
```console
xrepo install -p cross [--sdk=/xxx] materialx
```
...
```console
xrepo install -p cross [--sdk=/xxx] mathter
```
...
```console
xrepo install -p cross [--sdk=/xxx] md4c
```
...
```console
xrepo install -p cross [--sdk=/xxx] melon
```
...
```console
xrepo install -p cross [--sdk=/xxx] meshoptimizer
```
...
```console
xrepo install -p cross [--sdk=/xxx] metalang99
```
...
```console
xrepo install -p cross [--sdk=/xxx] metis
```
...
```console
xrepo install -p cross [--sdk=/xxx] microsoft-kuku
```
...
```console
xrepo install -p cross [--sdk=/xxx] microsoft-seal
```
...
```console
xrepo install -p cross [--sdk=/xxx] mimalloc
```
...
```console
xrepo install -p cross [--sdk=/xxx] mini
```
...
```console
xrepo install -p cross [--sdk=/xxx] minja
```
...
```console
xrepo install -p cross [--sdk=/xxx] mmeter
```
...
```console
xrepo install -p cross [--sdk=/xxx] mongoose
```
...
```console
xrepo install -p cross [--sdk=/xxx] morton-nd
```
...
```console
xrepo install -p cross [--sdk=/xxx] mpfr
```
...
```console
xrepo install -p cross [--sdk=/xxx] mpg123
```
...
```console
xrepo install -p cross [--sdk=/xxx] mplib
```
...
```console
xrepo install -p cross [--sdk=/xxx] mscharconv
```
...
```console
xrepo install -p cross [--sdk=/xxx] msdf-atlas-gen
```
...
```console
xrepo install -p cross [--sdk=/xxx] msgpack23
```
...
```console
xrepo install -p cross [--sdk=/xxx] msvc
```
...
```console
xrepo install -p cross [--sdk=/xxx] msvc-wine
```
...
```console
xrepo install -p cross [--sdk=/xxx] mujoco
```
...
```console
xrepo install -p cross [--sdk=/xxx] mujs
```
...
```console
xrepo install -p cross [--sdk=/xxx] muparserx
```
...
```console
xrepo install -p cross [--sdk=/xxx] nanoarrow
```
...
```console
xrepo install -p cross [--sdk=/xxx] nanomsg
```
...
```console
xrepo install -p cross [--sdk=/xxx] nanopb
```
...
```console
xrepo install -p cross [--sdk=/xxx] nazarautils
```
...
```console
xrepo install -p cross [--sdk=/xxx] ncnn
```
...
```console
xrepo install -p cross [--sdk=/xxx] ncurses
```
...
```console
xrepo install -p cross [--sdk=/xxx] neargye-scope_guard
```
...
```console
xrepo install -p cross [--sdk=/xxx] nettle
```
...
```console
xrepo install -p cross [--sdk=/xxx] ng-log
```
...
```console
xrepo install -p cross [--sdk=/xxx] nghttp2
```
...
```console
xrepo install -p cross [--sdk=/xxx] nghttp3
```
...
```console
xrepo install -p cross [--sdk=/xxx] nim
```
...
```console
xrepo install -p cross [--sdk=/xxx] nmd
```
...
```console
xrepo install -p cross [--sdk=/xxx] node-addon-api
```
...
```console
xrepo install -p cross [--sdk=/xxx] node-api-headers
```
...
```console
xrepo install -p cross [--sdk=/xxx] node-api-stub
```
...
```console
xrepo install -p cross [--sdk=/xxx] node_crunch2
```
...
```console
xrepo install -p cross [--sdk=/xxx] noisy
```
...
```console
xrepo install -p cross [--sdk=/xxx] nowide_standalone
```
...
```console
xrepo install -p cross [--sdk=/xxx] nsync
```
...
```console
xrepo install -p cross [--sdk=/xxx] nuklear
```
...
```console
xrepo install -p cross [--sdk=/xxx] nzsl
```
...
```console
xrepo install -p cross [--sdk=/xxx] obfuscate
```
...
```console
xrepo install -p cross [--sdk=/xxx] obfusheader.h
```
...
```console
xrepo install -p cross [--sdk=/xxx] observer-ptr-lite
```
...
```console
xrepo install -p cross [--sdk=/xxx] octree
```
...
```console
xrepo install -p cross [--sdk=/xxx] offsetallocator
```
...
```console
xrepo install -p cross [--sdk=/xxx] omath
```
...
```console
xrepo install -p cross [--sdk=/xxx] ompl
```
...
```console
xrepo install -p cross [--sdk=/xxx] oneshot
```
...
```console
xrepo install -p cross [--sdk=/xxx] onnx
```
...
```console
xrepo install -p cross [--sdk=/xxx] openai-cpp
```
...
```console
xrepo install -p cross [--sdk=/xxx] openblas
```
...
```console
xrepo install -p cross [--sdk=/xxx] opencc
```
...
```console
xrepo install -p cross [--sdk=/xxx] opencolorio
```
...
```console
xrepo install -p cross [--sdk=/xxx] opencore-amr
```
...
```console
xrepo install -p cross [--sdk=/xxx] openexr
```
...
```console
xrepo install -p cross [--sdk=/xxx] openfbx
```
...
```console
xrepo install -p cross [--sdk=/xxx] openh264
```
...
```console
xrepo install -p cross [--sdk=/xxx] openimagedenoise
```
...
```console
xrepo install -p cross [--sdk=/xxx] openjph
```
...
```console
xrepo install -p cross [--sdk=/xxx] openssh
```
...
```console
xrepo install -p cross [--sdk=/xxx] openxlsx
```
...
```console
xrepo install -p cross [--sdk=/xxx] optional-lite
```
...
```console
xrepo install -p cross [--sdk=/xxx] osip
```
...
```console
xrepo install -p cross [--sdk=/xxx] osmanip
```
...
```console
xrepo install -p cross [--sdk=/xxx] osqp
```
...
```console
xrepo install -p cross [--sdk=/xxx] p11-kit
```
...
```console
xrepo install -p cross [--sdk=/xxx] pahomqttc
```
...
```console
xrepo install -p cross [--sdk=/xxx] pahomqttcpp
```
...
```console
xrepo install -p cross [--sdk=/xxx] pango
```
...
```console
xrepo install -p cross [--sdk=/xxx] par
```
...
```console
xrepo install -p cross [--sdk=/xxx] pcg-cpp
```
...
```console
xrepo install -p cross [--sdk=/xxx] pdfio
```
...
```console
xrepo install -p cross [--sdk=/xxx] pe-parse
```
...
```console
xrepo install -p cross [--sdk=/xxx] pedeps
```
...
```console
xrepo install -p cross [--sdk=/xxx] pffft
```
...
```console
xrepo install -p cross [--sdk=/xxx] physfs
```
...
```console
xrepo install -p cross [--sdk=/xxx] picosha2
```
...
```console
xrepo install -p cross [--sdk=/xxx] pinocchio
```
...
```console
xrepo install -p cross [--sdk=/xxx] pl_mpeg
```
...
```console
xrepo install -p cross [--sdk=/xxx] plf_colony
```
...
```console
xrepo install -p cross [--sdk=/xxx] plf_nanotimer
```
...
```console
xrepo install -p cross [--sdk=/xxx] plotlypp
```
...
```console
xrepo install -p cross [--sdk=/xxx] plusaes
```
...
```console
xrepo install -p cross [--sdk=/xxx] plutosvg
```
...
```console
xrepo install -p cross [--sdk=/xxx] pocketfft
```
...
```console
xrepo install -p cross [--sdk=/xxx] poco
```
...
```console
xrepo install -p cross [--sdk=/xxx] poly2tri
```
...
```console
xrepo install -p cross [--sdk=/xxx] polyclipping
```
...
```console
xrepo install -p cross [--sdk=/xxx] proj
```
...
```console
xrepo install -p cross [--sdk=/xxx] protobuf-cpp
```
...
```console
xrepo install -p cross [--sdk=/xxx] pugixml
```
...
```console
xrepo install -p cross [--sdk=/xxx] qcbor
```
...
```console
xrepo install -p cross [--sdk=/xxx] qdldl
```
...
```console
xrepo install -p cross [--sdk=/xxx] qhull
```
...
```console
xrepo install -p cross [--sdk=/xxx] qmsetup
```
...
```console
xrepo install -p cross [--sdk=/xxx] qoa
```
...
```console
xrepo install -p cross [--sdk=/xxx] qpoases
```
...
```console
xrepo install -p cross [--sdk=/xxx] qr-code-generator-c
```
...
```console
xrepo install -p cross [--sdk=/xxx] qr-code-generator-cpp
```
...
```console
xrepo install -p cross [--sdk=/xxx] quantlib
```
...
```console
xrepo install -p cross [--sdk=/xxx] quickjs-ng
```
...
```console
xrepo install -p cross [--sdk=/xxx] quirc
```
...
```console
xrepo install -p cross [--sdk=/xxx] radeonrays
```
...
```console
xrepo install -p cross [--sdk=/xxx] ragel
```
...
```console
xrepo install -p cross [--sdk=/xxx] rang
```
...
```console
xrepo install -p cross [--sdk=/xxx] rapidfuzz
```
...
```console
xrepo install -p cross [--sdk=/xxx] rapidhash
```
...
```console
xrepo install -p cross [--sdk=/xxx] rapidobj
```
...
```console
xrepo install -p cross [--sdk=/xxx] re-flex
```
...
```console
xrepo install -p cross [--sdk=/xxx] re2c
```
...
```console
xrepo install -p cross [--sdk=/xxx] reaction
```
...
```console
xrepo install -p cross [--sdk=/xxx] readline
```
...
```console
xrepo install -p cross [--sdk=/xxx] reflect-cpp
```
...
```console
xrepo install -p cross [--sdk=/xxx] resiprocate
```
...
```console
xrepo install -p cross [--sdk=/xxx] restinio
```
...
```console
xrepo install -p cross [--sdk=/xxx] ricab-scope_guard
```
...
```console
xrepo install -p cross [--sdk=/xxx] ring-span-lite
```
...
```console
xrepo install -p cross [--sdk=/xxx] riscv32-esp-elf
```
...
```console
xrepo install -p cross [--sdk=/xxx] robotstxt
```
...
```console
xrepo install -p cross [--sdk=/xxx] rocket
```
...
```console
xrepo install -p cross [--sdk=/xxx] rpclib
```
...
```console
xrepo install -p cross [--sdk=/xxx] rsm-binary-io
```
...
```console
xrepo install -p cross [--sdk=/xxx] rsm-mmio
```
...
```console
xrepo install -p cross [--sdk=/xxx] rtm
```
...
```console
xrepo install -p cross [--sdk=/xxx] rust
```
...
```console
xrepo install -p cross [--sdk=/xxx] rustup
```
...
```console
xrepo install -p cross [--sdk=/xxx] sdsl-lite
```
...
```console
xrepo install -p cross [--sdk=/xxx] semver
```
...
```console
xrepo install -p cross [--sdk=/xxx] seqan3
```
...
```console
xrepo install -p cross [--sdk=/xxx] sfl-library
```
...
```console
xrepo install -p cross [--sdk=/xxx] sfparse
```
...
```console
xrepo install -p cross [--sdk=/xxx] sha2
```
...
```console
xrepo install -p cross [--sdk=/xxx] shaderc
```
...
```console
xrepo install -p cross [--sdk=/xxx] sheenbidi
```
...
```console
xrepo install -p cross [--sdk=/xxx] sigslot
```
...
```console
xrepo install -p cross [--sdk=/xxx] simdjson
```
...
```console
xrepo install -p cross [--sdk=/xxx] simdutf
```
...
```console
xrepo install -p cross [--sdk=/xxx] simple_http
```
...
```console
xrepo install -p cross [--sdk=/xxx] simplecpp
```
...
```console
xrepo install -p cross [--sdk=/xxx] sjpeg
```
...
```console
xrepo install -p cross [--sdk=/xxx] slikenet
```
...
```console
xrepo install -p cross [--sdk=/xxx] snmalloc
```
...
```console
xrepo install -p cross [--sdk=/xxx] sobjectizer
```
...
```console
xrepo install -p cross [--sdk=/xxx] socket-io-client
```
...
```console
xrepo install -p cross [--sdk=/xxx] sokol-tools
```
...
```console
xrepo install -p cross [--sdk=/xxx] soxr
```
...
```console
xrepo install -p cross [--sdk=/xxx] sparse-map
```
...
```console
xrepo install -p cross [--sdk=/xxx] spectra
```
...
```console
xrepo install -p cross [--sdk=/xxx] speex
```
...
```console
xrepo install -p cross [--sdk=/xxx] spine-runtimes
```
...
```console
xrepo install -p cross [--sdk=/xxx] spot
```
...
```console
xrepo install -p cross [--sdk=/xxx] sqlite-vec
```
...
| License | Public Domain |
| Versions | 3.23.0+0, 3.24.0+0, 3.34.0+100, 3.35.0+400, 3.35.0+300, 3.36.0+0, 3.37.0+200, 3.39.0+200, 3.43.0+200, 3.45.0+100, 3.45.0+200, 3.45.0+300, 3.46.0+100, 3.46.0+0, 3.47.0+0, 3.47.0+100, 3.47.0+200, 3.48.0+0, 3.49.0+200, 3.49.0+100, 3.49.0+0, 3.50.0+400, 3.50.0+300, 3.50.0+200, 3.50.0+100, 3.50.0+0, 3.51.0+300, 3.51.0+200, 3.51.0+0, 3.51.0+100, 3.53.0+0, 3.53.0+100, 3.53.0+200, 3.53.0+400 |
| Architectures | arm, arm64, armv7, i386, loong64, mips, mips64, mips64el, ppc, ppc64, ppc64el, riscv, riscv64, s390x, sh4, sparc64, x86_64 |
...
```console
xrepo install -p cross [--sdk=/xxx] sqrat
```
...
```console
xrepo install -p cross [--sdk=/xxx] squirrel
```
...
```console
xrepo install -p cross [--sdk=/xxx] srtp
```
...
```console
xrepo install -p cross [--sdk=/xxx] sse2rvv
```
...
```console
xrepo install -p cross [--sdk=/xxx] standardlib
```
...
```console
xrepo install -p cross [--sdk=/xxx] status-code
```
...
```console
xrepo install -p cross [--sdk=/xxx] stfl
```
...
```console
xrepo install -p cross [--sdk=/xxx] stx
```
...
```console
xrepo install -p cross [--sdk=/xxx] swisseph
```
...
```console
xrepo install -p cross [--sdk=/xxx] symengine
```
...
```console
xrepo install -p cross [--sdk=/xxx] syscmdline
```
...
```console
xrepo install -p cross [--sdk=/xxx] ta-lib
```
...
```console
xrepo install -p cross [--sdk=/xxx] taocpp-json
```
...
```console
xrepo install -p cross [--sdk=/xxx] texinfo
```
...
```console
xrepo install -p cross [--sdk=/xxx] tf_workstealingqueue
```
...
```console
xrepo install -p cross [--sdk=/xxx] think-cell-library
```
...
```console
xrepo install -p cross [--sdk=/xxx] tidy-html5
```
...
```console
xrepo install -p cross [--sdk=/xxx] tiltedcore
```
...
```console
xrepo install -p cross [--sdk=/xxx] tiny-aes-c
```
...
```console
xrepo install -p cross [--sdk=/xxx] tinyalloc
```
...
```console
xrepo install -p cross [--sdk=/xxx] tinycolormap
```
...
```console
xrepo install -p cross [--sdk=/xxx] tinycthread
```
...
```console
xrepo install -p cross [--sdk=/xxx] tinyjpeg
```
...
```console
xrepo install -p cross [--sdk=/xxx] tinymcp
```
...
```console
xrepo install -p cross [--sdk=/xxx] tinyspline
```
...
```console
xrepo install -p cross [--sdk=/xxx] tinyxml2
```
...
```console
xrepo install -p cross [--sdk=/xxx] tlsf
```
...
```console
xrepo install -p cross [--sdk=/xxx] tmxlite
```
...
```console
xrepo install -p cross [--sdk=/xxx] tobiaslocker_base64
```
...
```console
xrepo install -p cross [--sdk=/xxx] tomlc17
```
...
```console
xrepo install -p cross [--sdk=/xxx] tomlc99
```
...
```console
xrepo install -p cross [--sdk=/xxx] tomlcpp
```
...
```console
xrepo install -p cross [--sdk=/xxx] toppra
```
...
```console
xrepo install -p cross [--sdk=/xxx] tracy
```
...
```console
xrepo install -p cross [--sdk=/xxx] trantor
```
...
```console
xrepo install -p cross [--sdk=/xxx] tree-sitter
```
...
```console
xrepo install -p cross [--sdk=/xxx] tvision
```
...
```console
xrepo install -p cross [--sdk=/xxx] tweeny
```
...
```console
xrepo install -p cross [--sdk=/xxx] udis86
```
...
```console
xrepo install -p cross [--sdk=/xxx] udt
```
...
```console
xrepo install -p cross [--sdk=/xxx] ufbx
```
...
```console
xrepo install -p cross [--sdk=/xxx] unicorn
```
...
```console
xrepo install -p cross [--sdk=/xxx] unity_test
```
...
```console
xrepo install -p cross [--sdk=/xxx] urdfdom
```
...
```console
xrepo install -p cross [--sdk=/xxx] uriparser
```
...
```console
xrepo install -p cross [--sdk=/xxx] usrsctp
```
...
```console
xrepo install -p cross [--sdk=/xxx] uthash
```
...
```console
xrepo install -p cross [--sdk=/xxx] util-macros
```
...
```console
xrepo install -p cross [--sdk=/xxx] uuid_v4
```
...
```console
xrepo install -p cross [--sdk=/xxx] uvw
```
...
```console
xrepo install -p cross [--sdk=/xxx] valijson
```
...
```console
xrepo install -p cross [--sdk=/xxx] vamp-plugin-sdk
```
...
```console
xrepo install -p cross [--sdk=/xxx] variant-lite
```
...
```console
xrepo install -p cross [--sdk=/xxx] vcpkg
```
...
### vladimirshaleev-ipaddress (cross)
...
```console
xrepo install -p cross [--sdk=/xxx] vladimirshaleev-ipaddress
```
...
```console
xrepo install -p cross [--sdk=/xxx] vmaf
```
...
```console
xrepo install -p cross [--sdk=/xxx] vvenc
```
...
```console
xrepo install -p cross [--sdk=/xxx] websocketpp
```
...
```console
xrepo install -p cross [--sdk=/xxx] wgsl-validator
```
...
```console
xrepo install -p cross [--sdk=/xxx] whereami
```
...
```console
xrepo install -p cross [--sdk=/xxx] which
```
...
```console
xrepo install -p cross [--sdk=/xxx] wirehair
```
...
```console
xrepo install -p cross [--sdk=/xxx] wjakob_filesystem
```
...
```console
xrepo install -p cross [--sdk=/xxx] woff2
```
...
```console
xrepo install -p cross [--sdk=/xxx] wren
```
...
```console
xrepo install -p cross [--sdk=/xxx] xapian-core
```
...
```console
xrepo install -p cross [--sdk=/xxx] xcb-proto
```
...
```console
xrepo install -p cross [--sdk=/xxx] xent-core
```
...
```console
xrepo install -p cross [--sdk=/xxx] xgrammar
```
...
```console
xrepo install -p cross [--sdk=/xxx] xlsxio
```
...
```console
xrepo install -p cross [--sdk=/xxx] xor_singleheader
```
...
```console
xrepo install -p cross [--sdk=/xxx] xorgproto
```
...
```console
xrepo install -p cross [--sdk=/xxx] xproperty
```
...
```console
xrepo install -p cross [--sdk=/xxx] xtensa-esp-elf
```
...
```console
xrepo install -p cross [--sdk=/xxx] xtl
```
...
```console
xrepo install -p cross [--sdk=/xxx] xtrans
```
...
```console
xrepo install -p cross [--sdk=/xxx] xxmlxx
```
...
```console
xrepo install -p cross [--sdk=/xxx] xz
```
...
```console
xrepo install -p cross [--sdk=/xxx] yaml_cpp_struct
```
...
```console
xrepo install -p cross [--sdk=/xxx] yojimbo
```
...
```console
xrepo install -p cross [--sdk=/xxx] zasm
```
...
```console
xrepo install -p cross [--sdk=/xxx] zbar
```
...
```console
xrepo install -p cross [--sdk=/xxx] zeromq
```
...
```console
xrepo install -p cross [--sdk=/xxx] zeus_expected
```
...
```console
xrepo install -p cross [--sdk=/xxx] zint
```
...
```console
xrepo install -p cross [--sdk=/xxx] zlog
```
...
```console
xrepo install -p cross [--sdk=/xxx] zoe
```
...
```console
xrepo install -p cross [--sdk=/xxx] zopfli
```
...
```console
xrepo install -p cross [--sdk=/xxx] zpp_bits
```
...
```console
xrepo install -p cross [--sdk=/xxx] zpp_throwing
```
...
```console
xrepo install -p cross [--sdk=/xxx] zstr
```
...
```console
xrepo install -p cross [--sdk=/xxx] zxing-cpp
```
...
```console
xrepo install -p cross [--sdk=/xxx] zziplib
```
