...
```console
xrepo install -p android [--ndk=/xxx] ace
```
...
```console
xrepo install -p android [--ndk=/xxx] acl-dev
```
...
```console
xrepo install -p android [--ndk=/xxx] aklomp-base64
```
...
```console
xrepo install -p android [--ndk=/xxx] alpaka
```
...
```console
xrepo install -p android [--ndk=/xxx] anari
```
...
```console
xrepo install -p android [--ndk=/xxx] appimage
```
...
```console
xrepo install -p android [--ndk=/xxx] approval-tests-cpp
```
...
| -- | -- |
| Homepage | [https://github.com/argp-standalone/argp-standalone](https://github.com/argp-standalone/argp-standalone) |
...
```console
xrepo install -p android [--ndk=/xxx] argus
```
...
```console
xrepo install -p android [--ndk=/xxx] asbind20
```
...
```console
xrepo install -p android [--ndk=/xxx] astc-encoder
```
...
```console
xrepo install -p android [--ndk=/xxx] aubio
```
...
```console
xrepo install -p android [--ndk=/xxx] aui
```
...
```console
xrepo install -p android [--ndk=/xxx] aui-toolbox
```
...
```console
xrepo install -p android [--ndk=/xxx] aurora-au
```
...
```console
xrepo install -p android [--ndk=/xxx] aws-c-auth
```
...
```console
xrepo install -p android [--ndk=/xxx] aws-c-http
```
...
```console
xrepo install -p android [--ndk=/xxx] aws-c-s3
```
...
```console
xrepo install -p android [--ndk=/xxx] aws-lc
```
...
```console
xrepo install -p android [--ndk=/xxx] babl
```
...
```console
xrepo install -p android [--ndk=/xxx] bandit
```
...
```console
xrepo install -p android [--ndk=/xxx] bass24
```
...
```console
xrepo install -p android [--ndk=/xxx] beaengine
```
...
```console
xrepo install -p android [--ndk=/xxx] binn
```
...
```console
xrepo install -p android [--ndk=/xxx] blobify
```
...
```console
xrepo install -p android [--ndk=/xxx] boost_assert
```
...
```console
xrepo install -p android [--ndk=/xxx] boost_math
```
...
```console
xrepo install -p android [--ndk=/xxx] boost_pfr
```
...
```console
xrepo install -p android [--ndk=/xxx] boost_static_assert
```
...
```console
xrepo install -p android [--ndk=/xxx] boost_throw_exception
```
...
```console
xrepo install -p android [--ndk=/xxx] boost_type_traits
```
...
```console
xrepo install -p android [--ndk=/xxx] boost_uuid
```
...
```console
xrepo install -p android [--ndk=/xxx] byte-lite
```
...
```console
xrepo install -p android [--ndk=/xxx] celero
```
...
```console
xrepo install -p android [--ndk=/xxx] choc
```
...
```console
xrepo install -p android [--ndk=/xxx] cli11
```
...
```console
xrepo install -p android [--ndk=/xxx] coal
```
...
```console
xrepo install -p android [--ndk=/xxx] coin-or-coinutils
```
...
```console
xrepo install -p android [--ndk=/xxx] coin-or-osi
```
...
```console
xrepo install -p android [--ndk=/xxx] console-bridge
```
...
```console
xrepo install -p android [--ndk=/xxx] cpp-jwt
```
...
```console
xrepo install -p android [--ndk=/xxx] cppad
```
...
```console
xrepo install -p android [--ndk=/xxx] cppli
```
...
```console
xrepo install -p android [--ndk=/xxx] cpr
```
...
```console
xrepo install -p android [--ndk=/xxx] crow
```
...
```console
xrepo install -p android [--ndk=/xxx] darts
```
...
```console
xrepo install -p android [--ndk=/xxx] dbus
```
...
```console
xrepo install -p android [--ndk=/xxx] eabase
```
...
```console
xrepo install -p android [--ndk=/xxx] embedded-xoodyak
```
...
```console
xrepo install -p android [--ndk=/xxx] emock
```
...
```console
xrepo install -p android [--ndk=/xxx] esp32-arduino-libs
```
...
```console
xrepo install -p android [--ndk=/xxx] esp32-devel
```
...
```console
xrepo install -p android [--ndk=/xxx] esptool
```
...
```console
xrepo install -p android [--ndk=/xxx] exosip
```
...
```console
xrepo install -p android [--ndk=/xxx] expresscpp
```
...
```console
xrepo install -p android [--ndk=/xxx] extra-cmake-modules
```
...
```console
xrepo install -p android [--ndk=/xxx] fadec
```
...
```console
xrepo install -p android [--ndk=/xxx] fann
```
...
```console
xrepo install -p android [--ndk=/xxx] fastmod
```
...
```console
xrepo install -p android [--ndk=/xxx] fcgi
```
...
```console
xrepo install -p android [--ndk=/xxx] fcl
```
...
```console
xrepo install -p android [--ndk=/xxx] fgt
```
...
```console
xrepo install -p android [--ndk=/xxx] filc
```
...
```console
xrepo install -p android [--ndk=/xxx] fixed-containers
```
...
```console
xrepo install -p android [--ndk=/xxx] fontconfig
```
...
```console
xrepo install -p android [--ndk=/xxx] freerdp
```
...
```console
xrepo install -p android [--ndk=/xxx] freexl
```
...
```console
xrepo install -p android [--ndk=/xxx] fribidi
```
...
```console
xrepo install -p android [--ndk=/xxx] gcem
```
...
```console
xrepo install -p android [--ndk=/xxx] gelldur-eventbus
```
...
```console
xrepo install -p android [--ndk=/xxx] geo-utils-cpp
```
...
```console
xrepo install -p android [--ndk=/xxx] geode-sdk-result
```
...
```console
xrepo install -p android [--ndk=/xxx] geos
```
...
```console
xrepo install -p android [--ndk=/xxx] ggml
```
...
```console
xrepo install -p android [--ndk=/xxx] gloo
```
...
| Description | *A simple android NativeHook library.* |
| -- | -- |
| Homepage | [https://github.com/XMDS/GlossHook](https://github.com/XMDS/GlossHook) |
| License | MIT |
| Versions | v1.9.5 |
| Architectures | arm64-v8a, armeabi, armeabi-v7a, mip64, mips, riscv64, x86, x86_64 |
| Definition | [glosshook/xmake.lua](https://github.com/xmake-io/xmake-repo/blob/master/packages/g/glosshook/xmake.lua) |

##### Install command

```console
xrepo install -p android [--ndk=/xxx] glosshook
```

##### Integration in the project (xmake.lua)

```lua
add_requires("glosshook")
```
...
```console
xrepo install -p android [--ndk=/xxx] glpk
```
...
```console
xrepo install -p android [--ndk=/xxx] glslang-nihui
```
...
```console
xrepo install -p android [--ndk=/xxx] gmp
```
...
```console
xrepo install -p android [--ndk=/xxx] gtl
```
...
```console
xrepo install -p android [--ndk=/xxx] gz-cmake
```
...
```console
xrepo install -p android [--ndk=/xxx] gz-utils
```
...
```console
xrepo install -p android [--ndk=/xxx] h3
```
...
```console
xrepo install -p android [--ndk=/xxx] handy
```
...
```console
xrepo install -p android [--ndk=/xxx] hiredis-vip
```
...
```console
xrepo install -p android [--ndk=/xxx] hyperscan
```
...
```console
xrepo install -p android [--ndk=/xxx] hyprwayland-scanner
```
...
```console
xrepo install -p android [--ndk=/xxx] icu4c
```
...
```console
xrepo install -p android [--ndk=/xxx] implot3d
```
...
```console
xrepo install -p android [--ndk=/xxx] incbin
```
...
```console
xrepo install -p android [--ndk=/xxx] jack2
```
...
```console
xrepo install -p android [--ndk=/xxx] jemalloc
```
...
```console
xrepo install -p android [--ndk=/xxx] jrtplib
```
...
```console
xrepo install -p android [--ndk=/xxx] json-schema-validator
```
...
```console
xrepo install -p android [--ndk=/xxx] jthread
```
...
```console
xrepo install -p android [--ndk=/xxx] jwasm
```
...
```console
xrepo install -p android [--ndk=/xxx] kittymemory
```
...
```console
xrepo install -p android [--ndk=/xxx] lastools
```
...
```console
xrepo install -p android [--ndk=/xxx] lcms
```
...
```console
xrepo install -p android [--ndk=/xxx] ldtkloader
```
...
```console
xrepo install -p android [--ndk=/xxx] leveldb
```
...
```console
xrepo install -p android [--ndk=/xxx] libdatachannel
```
...
```console
xrepo install -p android [--ndk=/xxx] libdispatch
```
...
```console
xrepo install -p android [--ndk=/xxx] libeconf
```
...
```console
xrepo install -p android [--ndk=/xxx] libhat
```
...
```console
xrepo install -p android [--ndk=/xxx] libid3tag
```
...
```console
xrepo install -p android [--ndk=/xxx] libjq
```
...
```console
xrepo install -p android [--ndk=/xxx] libkdtree
```
...
```console
xrepo install -p android [--ndk=/xxx] libkeyfinder
```
...
| License | LGPL-2.1 |
| Versions | v30, v31, v32, v33, v34, v34.2 |
| Architectures | arm64-v8a, armeabi, armeabi-v7a, mip64, mips, riscv64, x86, x86_64 |
...
```console
xrepo install -p android [--ndk=/xxx] libllvm
```
...
```console
xrepo install -p android [--ndk=/xxx] libmd
```
...
```console
xrepo install -p android [--ndk=/xxx] libmem
```
...
```console
xrepo install -p android [--ndk=/xxx] libmobi
```
...
```console
xrepo install -p android [--ndk=/xxx] libnpy-matajoh
```
...
```console
xrepo install -p android [--ndk=/xxx] libomp
```
...
```console
xrepo install -p android [--ndk=/xxx] libopenmpt
```
...
```console
xrepo install -p android [--ndk=/xxx] libp11
```
...
```console
xrepo install -p android [--ndk=/xxx] librats
```
...
```console
xrepo install -p android [--ndk=/xxx] libraw
```
...
```console
xrepo install -p android [--ndk=/xxx] librealsense
```
...
```console
xrepo install -p android [--ndk=/xxx] librttopo
```
...
```console
xrepo install -p android [--ndk=/xxx] libsdl2
```
...
```console
xrepo install -p android [--ndk=/xxx] libsdl2_image
```
...
```console
xrepo install -p android [--ndk=/xxx] libsdl2_mixer
```
...
```console
xrepo install -p android [--ndk=/xxx] libsdl2_mixer_x
```
...
```console
xrepo install -p android [--ndk=/xxx] libsdl2_net
```
...
```console
xrepo install -p android [--ndk=/xxx] libsdl2_ttf
```
...
```console
xrepo install -p android [--ndk=/xxx] libsdl3
```
...
```console
xrepo install -p android [--ndk=/xxx] libsdl3_image
```
...
```console
xrepo install -p android [--ndk=/xxx] libsdl3_ttf
```
...
```console
xrepo install -p android [--ndk=/xxx] libsolv
```
...
```console
xrepo install -p android [--ndk=/xxx] libtasn1
```
...
```console
xrepo install -p android [--ndk=/xxx] libtcod
```
...
```console
xrepo install -p android [--ndk=/xxx] libwebp
```
...
| License | Apache-2.0 |
| Versions | v0.10.6, v0.10.7, v0.10.8, v0.10.9, v0.11.1, v0.11.2, v0.11.3, v0.11.4, v0.11.5, v0.11.7, v0.11.11, v1.0.0, v1.0.1 |
| Architectures | arm64-v8a, armeabi, armeabi-v7a, mip64, mips, riscv64, x86, x86_64 |
...
```console
xrepo install -p android [--ndk=/xxx] libxls
```
...
```console
xrepo install -p android [--ndk=/xxx] libzchunk
```
...
```console
xrepo install -p android [--ndk=/xxx] linux-syscall-support
```
...
```console
xrepo install -p android [--ndk=/xxx] liquid-dsp
```
...
```console
xrepo install -p android [--ndk=/xxx] llgl
```
...
```console
xrepo install -p android [--ndk=/xxx] lockfree
```
...
```console
xrepo install -p android [--ndk=/xxx] lsquic
```
...
```console
xrepo install -p android [--ndk=/xxx] lunzip
```
...
```console
xrepo install -p android [--ndk=/xxx] lzma
```
...
```console
xrepo install -p android [--ndk=/xxx] manifold
```
...
```console
xrepo install -p android [--ndk=/xxx] marisa
```
...
```console
xrepo install -p android [--ndk=/xxx] marl
```
...
```console
xrepo install -p android [--ndk=/xxx] materialx
```
...
```console
xrepo install -p android [--ndk=/xxx] mdspan
```
...
```console
xrepo install -p android [--ndk=/xxx] meshoptimizer
```
...
```console
xrepo install -p android [--ndk=/xxx] microstl
```
...
```console
xrepo install -p android [--ndk=/xxx] minja
```
...
```console
xrepo install -p android [--ndk=/xxx] mpfr
```
...
```console
xrepo install -p android [--ndk=/xxx] mplib
```
...
```console
xrepo install -p android [--ndk=/xxx] msdf-atlas-gen
```
...
```console
xrepo install -p android [--ndk=/xxx] msgpack23
```
...
```console
xrepo install -p android [--ndk=/xxx] msvc
```
...
```console
xrepo install -p android [--ndk=/xxx] msvc-wine
```
...
```console
xrepo install -p android [--ndk=/xxx] muda
```
...
```console
xrepo install -p android [--ndk=/xxx] muparserx
```
...
```console
xrepo install -p android [--ndk=/xxx] nazarautils
```
...
```console
xrepo install -p android [--ndk=/xxx] ncnn
```
...
```console
xrepo install -p android [--ndk=/xxx] nettle
```
...
```console
xrepo install -p android [--ndk=/xxx] ng-log
```
...
```console
xrepo install -p android [--ndk=/xxx] nghttp2
```
...
```console
xrepo install -p android [--ndk=/xxx] node-addon-api
```
...
```console
xrepo install -p android [--ndk=/xxx] nowide_standalone
```
...
```console
xrepo install -p android [--ndk=/xxx] nzsl
```
...
```console
xrepo install -p android [--ndk=/xxx] obfusheader.h
```
...
| Description | *Oboe is a C++ library that makes it easy to build high-performance audio apps on Android.* |
| -- | -- |
| Homepage | [https://github.com/google/oboe](https://github.com/google/oboe) |
| License | Apache-2.0 |
| Versions | 1.9.3, 1.10.0 |
| Architectures | arm64-v8a, armeabi, armeabi-v7a, mip64, mips, riscv64, x86, x86_64 |
| Definition | [oboe/xmake.lua](https://github.com/xmake-io/xmake-repo/blob/master/packages/o/oboe/xmake.lua) |

##### Install command

```console
xrepo install -p android [--ndk=/xxx] oboe
```
...
```console
xrepo install -p android [--ndk=/xxx] observer-ptr-lite
```
...
```console
xrepo install -p android [--ndk=/xxx] octree
```
...
```console
xrepo install -p android [--ndk=/xxx] oneshot
```
...
```console
xrepo install -p android [--ndk=/xxx] openai-cpp
```
...
```console
xrepo install -p android [--ndk=/xxx] openblas
```
...
```console
xrepo install -p android [--ndk=/xxx] opencc
```
...
```console
xrepo install -p android [--ndk=/xxx] opencolorio
```
...
```console
xrepo install -p android [--ndk=/xxx] opencv
```
...
```console
xrepo install -p android [--ndk=/xxx] opencv-mobile
```
...
```console
xrepo install -p android [--ndk=/xxx] openjph
```
...
```console
xrepo install -p android [--ndk=/xxx] openssh
```
...
```console
xrepo install -p android [--ndk=/xxx] openxr
```
...
```console
xrepo install -p android [--ndk=/xxx] orocos-kdl
```
...
```console
xrepo install -p android [--ndk=/xxx] osip
```
...
```console
xrepo install -p android [--ndk=/xxx] par
```
...
```console
xrepo install -p android [--ndk=/xxx] poly2tri
```
...
```console
xrepo install -p android [--ndk=/xxx] qpoases
```
...
```console
xrepo install -p android [--ndk=/xxx] qt6base
```
...
```console
xrepo install -p android [--ndk=/xxx] qt6core
```
...
```console
xrepo install -p android [--ndk=/xxx] qt6gui
```
...
```console
xrepo install -p android [--ndk=/xxx] qt6network
```
...
```console
xrepo install -p android [--ndk=/xxx] qt6qml
```
...
```console
xrepo install -p android [--ndk=/xxx] qt6quick
```
...
```console
xrepo install -p android [--ndk=/xxx] qt6widgets
```
...
```console
xrepo install -p android [--ndk=/xxx] radeonrays
```
...
```console
xrepo install -p android [--ndk=/xxx] ragel
```
...
```console
xrepo install -p android [--ndk=/xxx] randx
```
...
```console
xrepo install -p android [--ndk=/xxx] re2c
```
...
```console
xrepo install -p android [--ndk=/xxx] reaction
```
...
```console
xrepo install -p android [--ndk=/xxx] riscv32-esp-elf
```
...
```console
xrepo install -p android [--ndk=/xxx] rtm
```
...
```console
xrepo install -p android [--ndk=/xxx] rust
```
...
```console
xrepo install -p android [--ndk=/xxx] rustup
```
...
```console
xrepo install -p android [--ndk=/xxx] sdformat
```
...
```console
xrepo install -p android [--ndk=/xxx] sha2
```
...
| Description | *ShadowHook is an Android inline hook library which supports thumb, arm32 and arm64.* |
| -- | -- |
...
```console
xrepo install -p android [--ndk=/xxx] shadowhook
```
...
```console
xrepo install -p android [--ndk=/xxx] sigslot
```
...
```console
xrepo install -p android [--ndk=/xxx] simdjson
```
...
```console
xrepo install -p android [--ndk=/xxx] simplecpp
```
...
```console
xrepo install -p android [--ndk=/xxx] sjpeg
```
...
```console
xrepo install -p android [--ndk=/xxx] slikenet
```
...
```console
xrepo install -p android [--ndk=/xxx] socket-io-client
```
...
```console
xrepo install -p android [--ndk=/xxx] sokol-tools
```
...
```console
xrepo install -p android [--ndk=/xxx] soxr
```
...
```console
xrepo install -p android [--ndk=/xxx] spectra
```
...
```console
xrepo install -p android [--ndk=/xxx] speex
```
...
```console
xrepo install -p android [--ndk=/xxx] spot
```
...
| License | Public Domain |
| Versions | 3.23.0+0, 3.24.0+0, 3.34.0+100, 3.35.0+400, 3.35.0+300, 3.36.0+0, 3.37.0+200, 3.39.0+200, 3.43.0+200, 3.45.0+200, 3.45.0+300, 3.45.0+100, 3.46.0+100, 3.46.0+0, 3.47.0+100, 3.47.0+200, 3.47.0+0, 3.48.0+0, 3.49.0+200, 3.49.0+100, 3.49.0+0, 3.50.0+400, 3.50.0+300, 3.50.0+200, 3.50.0+100, 3.50.0+0, 3.51.0+200, 3.51.0+300, 3.51.0+100, 3.51.0+0, 3.53.0+100, 3.53.0+200, 3.53.0+0, 3.53.0+400 |
| Architectures | arm64-v8a, armeabi, armeabi-v7a, mip64, mips, riscv64, x86, x86_64 |
...
```console
xrepo install -p android [--ndk=/xxx] sqrat
```
...
```console
xrepo install -p android [--ndk=/xxx] status-code
```
...
```console
xrepo install -p android [--ndk=/xxx] steam-audio
```
...
```console
xrepo install -p android [--ndk=/xxx] stfl
```
...
```console
xrepo install -p android [--ndk=/xxx] swisseph
```
...
```console
xrepo install -p android [--ndk=/xxx] taocpp-json
```
...
```console
xrepo install -p android [--ndk=/xxx] think-cell-library
```
...
```console
xrepo install -p android [--ndk=/xxx] tiltedcore
```
...
```console
xrepo install -p android [--ndk=/xxx] tinycthread
```
...
```console
xrepo install -p android [--ndk=/xxx] tinyjpeg
```
...
```console
xrepo install -p android [--ndk=/xxx] tinymcp
```
...
```console
xrepo install -p android [--ndk=/xxx] tinyspline
```
...
```console
xrepo install -p android [--ndk=/xxx] tomlc17
```
...
```console
xrepo install -p android [--ndk=/xxx] tracy
```
...
```console
xrepo install -p android [--ndk=/xxx] trantor
```
...
```console
xrepo install -p android [--ndk=/xxx] tvision
```
...
```console
xrepo install -p android [--ndk=/xxx] udis86
```
...
```console
xrepo install -p android [--ndk=/xxx] urdfdom
```
...
```console
xrepo install -p android [--ndk=/xxx] uriparser
```
...
```console
xrepo install -p android [--ndk=/xxx] usrsctp
```
...
```console
xrepo install -p android [--ndk=/xxx] uuid_v4
```
...
```console
xrepo install -p android [--ndk=/xxx] valijson
```
...
```console
xrepo install -p android [--ndk=/xxx] vamp-plugin-sdk
```
...
```console
xrepo install -p android [--ndk=/xxx] vulkanscenegraph
```
...
```console
xrepo install -p android [--ndk=/xxx] websocketpp
```
...
```console
xrepo install -p android [--ndk=/xxx] woff2
```
...
| Homepage | [https://github.com/sogou/workflow](https://github.com/sogou/workflow) |
| License | Apache-2.0 |
| Versions | v0.10.6, v0.10.7, v0.10.8, v0.10.9, v0.11.1, v0.11.2, v0.11.3, v0.11.4, v0.11.9, v0.11.11, v1.0.0, v1.0.1 |
| Architectures | arm64-v8a, armeabi, armeabi-v7a, mip64, mips, riscv64, x86, x86_64 |
...
```console
xrepo install -p android [--ndk=/xxx] xapian-core
```
...
| -- | -- |
| Homepage | [https://github.com/hexhacking/xDL](https://github.com/hexhacking/xDL) |
| License | MIT |
| Versions | v2.2.0, v2.3.0, v2.4.0 |
| Architectures | arm64-v8a, armeabi, armeabi-v7a, mip64, mips, riscv64, x86, x86_64 |
| Definition | [xdl/xmake.lua](https://github.com/xmake-io/xmake-repo/blob/master/packages/x/xdl/xmake.lua) |

##### Install command

```console
xrepo install -p android [--ndk=/xxx] xdl
```
...
```console
xrepo install -p android [--ndk=/xxx] xor_singleheader
```
...
```console
xrepo install -p android [--ndk=/xxx] xproperty
```
...
```console
xrepo install -p android [--ndk=/xxx] xtensa-esp-elf
```
...
```console
xrepo install -p android [--ndk=/xxx] xtl
```
...
| Description | *:fire: xUnwind is a collection of Android native stack unwinding solutions.* |
| -- | -- |
| Homepage | [https://github.com/hexhacking/xUnwind](https://github.com/hexhacking/xUnwind) |
| License | MIT |
| Versions | v2.0.0 |
| Architectures | arm64-v8a, armeabi, armeabi-v7a, mip64, mips, riscv64, x86, x86_64 |
| Definition | [xunwind/xmake.lua](https://github.com/xmake-io/xmake-repo/blob/master/packages/x/xunwind/xmake.lua) |

##### Install command

```console
xrepo install -p android [--ndk=/xxx] xunwind
```

##### Integration in the project (xmake.lua)

```lua
add_requires("xunwind")
```
...
```console
xrepo install -p android [--ndk=/xxx] xxmlxx
```
...
```console
xrepo install -p android [--ndk=/xxx] xz
```
...
```console
xrepo install -p android [--ndk=/xxx] yaml_cpp_struct
```
...
```console
xrepo install -p android [--ndk=/xxx] yojimbo
```
...
```console
xrepo install -p android [--ndk=/xxx] zint
```
...
```console
xrepo install -p android [--ndk=/xxx] zix
```
...
```console
xrepo install -p android [--ndk=/xxx] zoe
```
...
```console
xrepo install -p android [--ndk=/xxx] zstr
```
...
```console
xrepo install -p android [--ndk=/xxx] zziplib
```
